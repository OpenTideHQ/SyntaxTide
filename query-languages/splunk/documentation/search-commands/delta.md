...
sourcetype=access\_\* status=200 action=purchase | top clientip | delta count p=1
...
source=all\_month.csv place=\*alaska\* | delta \_time p=1 | rename delta(\_time) AS timeDeltaS | eval timeDeltaS=abs(timeDeltaS) | eval "Time Between Quakes"=tostring(timeDeltaS,"duration") | table place, \_time, "Time Between Quakes"
...
sourcetype=access\_\* | transaction JSESSIONID clientip startswith="view" endswith="purchase" | delta \_time AS timeDelta p=1 | eval timeDelta=abs(timeDelta) | eval timeDelta=tostring(timeDelta,"duration")
...
![This image shows part of the search results. It shows the last event in a transaction and the complete next transaction.](https://splunk.deploy.heretto.com/v4/deployments/lbx3FHoDR4kUISPo5g64/object/f8b5bca6-83a3-40f8-809e-51820d32e0a3?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..gdYIsRTdZgMJmk3ClBB_jKjgHzshhp8RamIqS3LnYZw)
