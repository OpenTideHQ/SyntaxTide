...
| `stats` | Provides statistics, grouped optionally by fields. See [Statistical and charting functions](/splunk-enterprise/search/spl-search-reference/10.0/statistical-and-charting-functions/statistical-and-charting-functions#id_102ea92e_a6a3_42a7_80ce_feb3069051e0__Statistical_and_charting_functions). |
...
These are commands you can use to add, extract, and modify fields or field values. The most useful command for manipulating fields is `eval` and its [statistical and charting functions](/splunk-enterprise/search/spl-search-reference/10.0/evaluation-functions/evaluation-functions#id_71626c78_36e3_447a_bb2d_1751088caa84__Evaluation_functions).
...
| `eval` | Calculates an expression and puts the value into a field. See also, [evaluation functions](/splunk-enterprise/search/spl-search-reference/10.0/evaluation-functions/evaluation-functions#id_71626c78_36e3_447a_bb2d_1751088caa84__Evaluation_functions). |
...
| `mstats` | Calculates statistics for the measurement, metric\_name, and dimension fields in metric indexes. |
| `outlier` | Removes outlying numerical values. |
| `rare` | Displays the least common values of a field. |
| `stats` | Provides statistics, grouped optionally by fields. See also, [Statistical and charting functions](/splunk-enterprise/search/spl-search-reference/10.0/statistical-and-charting-functions/statistical-and-charting-functions#id_102ea92e_a6a3_42a7_80ce_feb3069051e0__Statistical_and_charting_functions). |
...
| `where` | Performs arbitrary filtering on your data. See also, [Evaluation functions](/splunk-enterprise/search/spl-search-reference/10.0/evaluation-functions/evaluation-functions#id_71626c78_36e3_447a_bb2d_1751088caa84__Evaluation_functions). |
